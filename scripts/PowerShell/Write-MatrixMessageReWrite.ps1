<#	
	...
	===========================================================================
	 ...
	 Created on:   	2020-10-07 12:35 AM
	 Created by:   	cwaddel
	 Organization: 	
	 Filename:     	
	===========================================================================
...
function Write-MatrixMessage
{
	...
	param (
		[Parameter(ParameterSetName = 'MatrixMessage', Position = 0, Mandatory = $true)]
		[string]$Message,
		[Parameter(ParameterSetName = 'MatrixMessage')]
		[int]$MessageTimeOnScreen = 2000,
		[Parameter(ParameterSetName = 'MatrixMessage')]
		[ValidateSet('Black', 'White')]
		[String[]]$MessageEraseColor = "White",
		[Parameter(ParameterSetName = 'MatrixMessage')]
		[int]$MessageCharacterEraseTime = 100,
		[int]$maxcolumns,
		[int]$FrameWait = 0,
